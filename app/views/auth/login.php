...
<div class="bg-white p-10 rounded-2xl shadow-2xl w-full max-w-md border-2 border-black min-h-[500px]"> 
  ...
  <!-- Error message with caution icon and black border -->
  <?php if (!empty($error)): ?>
    <div id="errorMessage" class="flex items-center justify-center gap-2 bg-red-100 text-red-700 border border-black p-3 rounded mb-4 text-center text-sm font-medium">
