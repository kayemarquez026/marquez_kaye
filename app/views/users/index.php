...
<nav class="bg-white/50 backdrop-blur-md shadow-md">
  <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
    <h1 class="text-xl font-bold flex items-center gap-2 font-mono">
      <i class="fa-solid fa-users text-lg"></i> User Directory
    </h1>
  </div>
</nav>
...
<div class="max-w-6xl mx-auto mt-10 px-4">
  <div class="bg-white p-8 rounded-2xl shadow-2xl border-black border-2">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
      ...
      <a href="<?=site_url('users/create')?>"
        ...
        <i class="fa-solid fa-user-plus text-lg"></i> Add New User
      </a>
    </div>
